...
// Bitmaps
#include "DR1_Racing_Logo_sz64.h"
//#include "sexy-young-woman.h"
...
void Effect_Graphic(int nGraphicID, int nImageColumn) {
	...
	if (nImageColumn < oBitmap_width) {
		...
		for (uint16_t j = 0; j < nEffectWidth; j++) {
			g_cPixels[j].r = oBitmapBuffer[nIndex + j % oBitmap_height].r;
			g_cPixels[j].g = oBitmapBuffer[nIndex + j % oBitmap_height].g;
			g_cPixels[j].b = oBitmapBuffer[nIndex + j % oBitmap_height].b;
		}
